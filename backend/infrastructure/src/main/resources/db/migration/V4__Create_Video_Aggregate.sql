...
CREATE TABLE videos(
    ...
    rating VARCHAR(5) NOT NULL DEFAULT FALSE,
    ...
    CONSTRAINT fk_v_banner_id FOREIGN KEY (trailer_id) REFERENCES videos_image_media(id) ON DELETE CASCADE,
...
CREATE TABLE videos_cast_members(
    ...
    CONSTRAINT fk_vcms_genres_id FOREIGN KEY (cast_member_id) REFERENCES cast_members (id)
);