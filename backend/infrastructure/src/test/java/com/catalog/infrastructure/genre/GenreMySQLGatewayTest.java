...
//        Assertions.assertEquals(aGenre.getUpdatedAt(), actualGenre.getUpdatedAt());
    ...
    @Test
    public void givenAValidGenreWithoutCategories_whenCallsCreateGenreWithCategories_shouldPersistGenre() {
        final var filmes =
...
//        Assertions.assertEquals(aGenre.getDeletedAt(), actualGenre.getDeletedAt());
    ...
    @Test
    public void givenAValidGenreWithCategories_whenCallsCreateGenreCleaningCategories_shouldPersistGenre() {
        final var filmes =
                categoryGateway.create(Category.newCategory("Filmes", null, true));
        final var series =
                categoryGateway.create(Category.newCategory("Séries", null, true));
        ...
        final var test = genreRepository.save(GenreJpaEntity.from(aGenre));
        ...
        Assertions.assertEquals(expectedCategories, actualGenre.getCategories());
        Assertions.assertEquals(aGenre.getCreatedAt(), actualGenre.getCreatedAt());
       // Assertions.assertNotNull(aGenre.getUpdatedAt().isBefore(actualGenre.getUpdatedAt()));
